...
PreparedStatement ps=con.prepareStatement("update users SET empname =?,emprole=?,empemail=?,empdep=?,empproj=?,empnum=? where empid =?;");
...
out.println("you have succesfully updated");
%>
<a href="view.jsp">
